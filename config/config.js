...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\Neutrinocoin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Neutrinocoin/';
  if (isLinux) dataDir = process.env.HOME + '/.neutrinocoin/';
}
